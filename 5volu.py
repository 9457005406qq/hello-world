...
for time_step in t:
    ...
    #                     input_shape=(time_step,1),activation='relu'))
    ...
    data_test.head()
    price_test = data_test.loc[:,'volume']
    price_test.head()
    ...
    mse.append(totforenum/totnum*100)
    print("平均误差率MAE:",end="");
...
# result.to_csv('zapa_predict_volume.csv')
